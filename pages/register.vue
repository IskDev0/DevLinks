  ...
  <section class="container mx-auto">
    <div class="w-96 mx-auto mt-10">
      ...
      <form @submit.prevent="register" class="flex flex-col gap-4">
        ...
        <div class="flex items-center justify-between gap-2 py-2 px-4 rounded-lg border-2 border-gray-300 bg-white">
          <input v-model="confirmPassword" class="focus:outline-none" :type="confirmInputType" placeholder="Confirm password">
          <Icon color="#818181" @click="showConfirmPassword = !showConfirmPassword" :name="confirmIconType"/>
        </div>
        <input class="py-2 px-4 bg-violet-700 text-white rounded-xl font-semibold cursor-pointer" type="submit" value="Create account">
      </form>
